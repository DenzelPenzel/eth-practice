...
interface CounterInterface extends ethers.utils.Interface {
  ...
  events: {
    "CounterInc(uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "CounterInc"): EventFragment;
}

export type CounterIncEvent = TypedEvent<[BigNumber] & { counter: BigNumber }>;
...
export class Counter extends BaseContract {
  ...
  filters: {
    "CounterInc(uint256)"(
      counter?: null
    ): TypedEventFilter<[BigNumber], { counter: BigNumber }>;
